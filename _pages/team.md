...
<div style="display: block; min-height:105px">
![image-left]({{ site.url }}{{ site.baseurl }}/assets/images/team/erik.png){: .align-left} [**Erik Boertjes**](http://erikboertjes.com){:target="_blank"} joined the team in 2016 as an independent research engineer in the realm of data visualisation. Erik currently works as [Data Visualization Engineer](https://www.ams-institute.org/about-ams/team/ams-staff/erik-boertjes/){:target="_blank"} in the Urban Data Science team of the AMS institute.
</div>

<div style="display: block; min-height:105px">
![image-left]({{ site.url }}{{ site.baseurl }}/assets/images/team/ioannis.jpg){: .align-left} [**Ioannis Protonotarios**](https://protonotarios.info/about/){:target="_blank"} has been part of the team between 2017 and 2019. Ioannis worked as research engineer in the Social Data Lab, contributing with his expertise in Embedded Systems and IoT engineering to the activities of the [Smart Cities](https://www.tudelft.nl/en/eemcs/cooperation/delft-data-science/research/research-domains/smart-cities/) research domain of the [Delft Data Science](https://www.tudelft.nl/en/eemcs/cooperation/delft-data-science/) initiative.
</div>

<div style="display: block; min-height:105px">
![image-left]({{ site.url }}{{ site.baseurl }}/assets/images/team/manuel.jpg){: .align-left} [**Manuel Valle Torre**](https://www.linkedin.com/in/manuelvalletorre){:target="_blank"} has been part of the team between 2017 and 2018. Manuel was a driving force in the design and creation of the [SmartPub](https://pure.tudelft.nl/portal/files/47371741/39999403_p191_mesbah.pdf){:target="_blank"} platform, and contributed to research and education activities.
</div>
